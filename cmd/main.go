...
import (
	...
	webhookv1 "antware.xyz/route-validator/internal/webhook/v1"
...
func init() {
	...
	utilruntime.Must(routeopenshiftiov1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "db45039f.antware.xyz",
	...
	go config.WatchConfigFile(configPath, configManager)

	// nolint:goconst
	if os.Getenv("ENABLE_WEBHOOKS") != "false" {
		if err := webhookv1.SetupRouteWebhookWithManager(mgr, configManager); err != nil {
	...
	// nolint:goconst
	if os.Getenv("ENABLE_WEBHOOKS") != "false" {
		if err := webhookv1.SetupIngressWebhookWithManager(mgr, configManager); err != nil {
